...
import { getFlowerOrderAssignment, updateStage1Assignment, updateStage4Assignment } from '../../../api/flowerOrderAssignmentApi';
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-3">
                <button
                    onClick={() => navigate(`/order-assign/flower/stage1/${id}`, { state: { orderData: orderDetails } })}
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3">
                <button
                    onClick={() => navigate(`/order-assign/flower/stage3/${id}`)}
...
export default FlowerOrderAssignStage4;